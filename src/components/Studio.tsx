...
const Studio: React.FC<dataProps> = ({ data }) => {
  ...
  return (
    <>
      {data.map((item, i) => (
        <div key={i} className="h-[10rem] rounded-lg bg-gradient-to-b from-neutral-950 to-black relative px-5 hover:scale-105 transition-all duration-500 cursor-pointer flex justify-center items-center group shadow-md overflow-hidden">
