        ...
        <div className="text-white absolute bottom-0 w-full h-[100%] p-10  bg-gradient-to-r from-black flex items-end group-hover:opacity-0 transition-all duration-500">
          <div className=" w-full grid grid-cols-2">
            <div className="card-container">
              <h2 className="mt-2 mb-4 text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-300 to-white">{movieData.original_title || movieData.original_name}</h2>
              ...
              <p className=" opacity-70 text-[14px]">{movieData.overview.endsWith('.') ? movieData.overview.slice(0, -1) : movieData.overview}</p>
            </div>
          </div>
        </div>
      </div>
